...
def testerFact(imageCherchee,listeImagesRef,listeDesBOWSIFT,featureExtractor):
    debut = time.time()
    listeFact = fact.listerScoresFact(imageCherchee,listeImagesRef,listeDesBOWSIFT,featureExtractor)
    fin = time.time()
...
listeFactTriee = testerFact(cheminTest,nomsImage,listeDesBOWSIFT,featureExtractor)
